...
def render_graph_ReSTIR_SVGF():
    ...
    DLSSPass = createPass('DLSSPass', {'enabled': True, 'outputSize': IOSize.Default, 'profile': DLSSProfile.Balanced, 'motionVectorScale': DLSSMotionVectorScale.Relative, 'isHDR': False, 'sharpness': 0.0, 'exposure': 0.0})
    ...
    g.addEdge('SVGFPass.Filtered image', 'DLSSPass.color')
